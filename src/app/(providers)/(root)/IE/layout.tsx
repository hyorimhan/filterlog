...
function layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="w-full h-screen  ">
      ...
      <div className="h-[50px] w-[1280px]  space-x-5 mx-auto flex  justify-center items-center  border-y-0 bg-custom-green-400 border-2  border-x-custom-green-700 ">
        <Link
          href={'/official'}
          className="p-1  rounded-lg bg-custom-green-300 text-sm text-black "
        >
          매거진
        </Link>
        <Link
